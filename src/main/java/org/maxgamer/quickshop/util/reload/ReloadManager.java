...
public class ReloadManager {
    ...
    /**
     * Unregister all reloadable modules that same with specific class from
     * reloading registry
     *
        ...
        while (iterator.hasNext()) {
            ...
            try {
                ...
                if (reloadable.getReloadable() != null) {
                    ...
                    reloadResult = new ReloadResult(ReloadStatus.EXCEPTION, "Both reloadable and method not exists",
                            null);
