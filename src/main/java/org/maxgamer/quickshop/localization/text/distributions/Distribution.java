...
public interface Distribution {
     ...
     * @throws Exception The exception throws if any errors occurred while getting
     *                   file
     */
    @NotNull
    String getFile(String fileDistributionPath, String distributionLocale) throws Exception;
     ...
     */
    @NotNull
    String getFile(String fileDistributionPath, String distributionLocale, boolean forceFlush) throws Exception;
