...
public class InternalListener extends AbstractQSListener {
    ...
    public void shopCreate(ShopCreateEvent event) {
        ...
        if (loggingAction) {
            ...
            plugin.logEvent(new ShopCreationLog(event.getCreator(), event.getShop().saveToInfoStorage(),
                    BlockPosition.of(event.getShop().getLocation())));
    ...
    public void shopDelete(ShopDeleteEvent event) {
        ...
        if (loggingAction) {
            ...
            plugin.logEvent(
                    new ShopRemoveLog(Util.getNilUniqueId(), "Shop removed", event.getShop().saveToInfoStorage()));
    ...
    public void shopModeratorChanges(ShopModeratorChangedEvent event) {
        ...
        if (loggingAction) {
            ...
            plugin.logEvent(new ShopModeratorChangedLog(event.getShop().saveToInfoStorage(),
                    (SimpleShopModerator) event.getModerator()));
    ...
    public void shopPurchase(ShopSuccessPurchaseEvent event) {
        ...
        if (loggingAction) {
            ...
            plugin.logEvent(new ShopPurchaseLog(event.getShop().saveToInfoStorage(), event.getShop().getShopType(),
                    event.getPurchaser(), Util.getItemStackName(event.getShop().getItem()),
    ...
    public void shopInventoryCalc(ShopInventoryCalculateEvent event) {
        ...
        plugin.getDatabaseHelper().updateExternalInventoryProfileCache(event.getShop(), event.getSpace(),
                event.getStock());
