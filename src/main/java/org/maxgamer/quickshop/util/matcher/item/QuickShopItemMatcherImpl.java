...
public class QuickShopItemMatcherImpl implements ItemMatcher, Reloadable {
    ...
    public boolean matches(@Nullable ItemStack[] requireStack, @Nullable ItemStack[] givenStack) {
        ...
        // contain or match will cost n^n time in most
    ...
    public boolean matches(@Nullable ItemStack requireStack, @Nullable ItemStack givenStack) {
        ...
        if (requireStack == null || givenStack == null) {
            ...
            Util.debugLog("Match failed: A stack is null: " + "requireStack[" + requireStack + "] givenStack["
                    + givenStack + "]");
                ...
                @NotNull QuickShopItemMatcherImpl itemMatcher)
        {
            ...
            addIfEnable(itemMatcherConfig, "lores", ((meta1, meta2) -> {
                ...
                if (meta1.hasLore()) {
                    ...
                    return Arrays.deepEquals(Objects.requireNonNull(lores1).toArray(),
                            Objects.requireNonNull(lores2).toArray());
            ...
            addIfEnable(itemMatcherConfig, "shulkerBox", ((meta1, meta2) -> {
                ...
                if (meta1 instanceof BlockStateMeta) {
                    ...
                    if ((((BlockStateMeta) meta1).getBlockState() instanceof ShulkerBox) != ((BlockStateMeta) meta2)
                    ...
                    if (((BlockStateMeta) meta1).getBlockState() instanceof ShulkerBox) {
                        ...
                        return itemMatcher.matches(
                                ((ShulkerBox) ((BlockStateMeta) meta1).getBlockState()).getInventory().getContents(),
