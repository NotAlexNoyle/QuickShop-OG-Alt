...
public class ShopTransactionMessageTest extends TestBukkitBase {
    ...
    public void testV2PlainMessage() {
        ...
        ShopTransactionMessageContainer container = ShopTransactionMessageContainer
                .fromJson(ShopTransactionMessageContainer.fromJson(
                        "{\"message\":\"233333\",\"hoverItem\":\"item:\\n  \\u003d\\u003d: org.bukkit.inventory.ItemStack\\n  v: 2730\\n  type: JUNGLE_LOG\\n\",\"hoverText\":\"233333\"}")
                        .toJson());
        Assertions.assertEquals("233333", container.getMessage(null));
        ...
        container = ShopTransactionMessageContainer.fromJson(ShopTransactionMessageContainer.fromJson(
                "{\"message\":\"233333\",\"hoverItem\":\"item:\\n  \\u003d\\u003d: org.bukkit.inventory.ItemStack\\n  v: 2730\\n  type: JUNGLE_LOG\\n\"}")
                .toJson());
        Assertions.assertEquals("233333", container.getMessage(null));
        Assertions.assertEquals(
                ...
                container.getHoverItemStr());
        Assertions.assertNull(container.getHoverText(null));
        container = ShopTransactionMessageContainer
                .fromJson(ShopTransactionMessageContainer.fromJson("{\"message\":\"233333\"}").toJson());
        Assertions.assertEquals("233333", container.getMessage(null));
        Assertions.assertNull(container.getHoverItemStr());
        Assertions.assertNull(container.getHoverText(null));
    ...
    public void testModernMessage() {
        ...
        // V1
        ShopTransactionMessageContainer container = ShopTransactionMessageContainer
                .fromJson(ShopTransactionMessageContainer.ofPlainStr("ghost_chu is an lucky guy").toJson());
        Assertions.assertEquals("ghost_chu is an lucky guy", container.getMessage(null));
        Assertions.assertNull(container.getHoverItemStr());
        Assertions.assertNull(container.getHoverText(null));
        // V2
        container = ShopTransactionMessageContainer
                .fromJson(ShopTransactionMessageContainer.ofStrWithItem("ghost_chu", null, null).toJson());
        Assertions.assertEquals("ghost_chu", container.getMessage(null));
        Assertions.assertNull(container.getHoverItemStr());
        Assertions.assertNull(container.getHoverText(null));
        container = ShopTransactionMessageContainer
                .fromJson(ShopTransactionMessageContainer.ofStrWithItem("ghost_chu", "is", null).toJson());
        Assertions.assertEquals("ghost_chu", container.getMessage(null));
        Assertions.assertEquals("is", container.getHoverItemStr());
        Assertions.assertNull(container.getHoverText(null));
        container = ShopTransactionMessageContainer
                .fromJson(ShopTransactionMessageContainer.ofStrWithItem("ghost_chu", "is", "an lucky guy").toJson());
        Assertions.assertEquals("ghost_chu", container.getMessage(null));
        Assertions.assertEquals("is", container.getHoverItemStr());
        Assertions.assertEquals("an lucky guy", container.getHoverText(null));
        // V3
        container = ShopTransactionMessageContainer.fromJson(ShopTransactionMessageContainer
                .ofLocalizedMessageWithItem(LocalizedMessagePair.of("nearby-shop-this-way", "ghost_chu"), "is",
                        LocalizedMessagePair.of("nearby-shop-this-way", "ghost_chu"))
                .toJson());
        ...
        container = ShopTransactionMessageContainer.fromJson(ShopTransactionMessageContainer
                .ofLocalizedMessageWithItem(LocalizedMessagePair.of("nearby-shop-this-way", "ghost_chu"), "is", null)
                .toJson());
        Assertions.assertTrue(container.getMessage(null).contains("ghost_chu"));
        Assertions.assertEquals("is", container.getHoverItemStr());
        Assertions.assertNull(container.getHoverText(null));
        container = ShopTransactionMessageContainer.fromJson(ShopTransactionMessageContainer
                .ofLocalizedMessageWithItem(LocalizedMessagePair.of("nearby-shop-this-way", "ghost_chu"), null, null)
                .toJson());
        Assertions.assertTrue(container.getMessage(null).contains("ghost_chu"));
        Assertions.assertNull(container.getHoverItemStr());
        Assertions.assertNull(container.getHoverText(null));
