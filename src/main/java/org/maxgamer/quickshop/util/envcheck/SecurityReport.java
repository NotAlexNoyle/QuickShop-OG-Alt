...
public class SecurityReport {
    ...
    public void signatureFileMissing(String name) {
        ...
        buffer.append("META-INF signature missing: ").append("name=").append(name).append("\n");

    }

    public void signatureVerifyFail(ZipEntry zipEntry) {

        buffer.append("Signature Fail: ").append("name=").append(zipEntry.getName()).append(", ").append("crc=")
                .append(zipEntry.getCrc()).append(", ").append("time=").append(zipEntry.getTime()).append(", ")
    ...
    public void potentialInfected(ZipEntry zipEntry) {
        ...
        buffer.append("Potential Infected: ").append("name=").append(zipEntry.getName()).append(", ").append("crc=")
                .append(zipEntry.getCrc()).append(", ").append("time=").append(zipEntry.getTime()).append(", ")
                .append("method=").append(zipEntry.getMethod()).append("\n");
    ...
    public void manifestModified(PluginDescriptionFile desc) {
        ...
        buffer.append("Invalid Plugin Description: ").append("name=").append(desc.getName()).append(", ")
                .append("main=").append(desc.getMain()).append(", ").append("libraries=[")
                .append(Util.list2String(desc.getLibraries())).append("], ").append("provides=[")
                .append(Util.list2String(desc.getProvides())).append("]\n");
