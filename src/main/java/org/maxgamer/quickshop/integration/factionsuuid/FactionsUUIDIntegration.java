...
public class FactionsUUIDIntegration extends AbstractQSIntegratedPlugin {
    ...
    private boolean check(@NotNull Player player, @NotNull Location location, boolean createRequireOpen,
            boolean createRequireSafeZone, boolean createRequirePermanent, boolean createRequirePeaceful,
            boolean createRequireWilderness, boolean createRequireWarZone, boolean createRequireNormal,
            boolean createRequireOwn, List<String> createFlags, boolean whiteList)
    {
        ...
        if (createRequireOwn && !faction.getOwnerList(fLocation).contains(player.getName())) {
        ...
        for (String flag : createFlags) {
            ...
            if (permissibleAction != null
                    && !faction.hasAccess(FPlayers.getInstance().getByPlayer(player), permissibleAction, fLocation))
            {
    ...
    public boolean canCreateShopHere(@NotNull Player player, @NotNull Location location) {
        ...
        return check(player, location, createRequireOpen, createRequireSafeZone, createRequirePermanent,
                createRequirePeaceful, createRequireWilderness, createRequireWarZone, createRequireNormal,
                createRequireOwn, createFlags, whiteList);
    ...
    public boolean canTradeShopHere(@NotNull Player player, @NotNull Location location) {
        ...
        return check(player, location, tradeRequireOpen, tradeRequireSafeZone, tradeRequirePermanent,
                tradeRequirePeaceful, tradeRequireWilderness, tradeRequireWarZone, tradeRequireNormal, tradeRequireOwn,
                tradeFlags, whiteList);
