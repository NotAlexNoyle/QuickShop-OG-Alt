...
public class ShopTransactionMessageContainer {
    ...
    private static final Gson gson = new GsonBuilder()
            .registerTypeAdapter(ShopTransactionMessageContainer.class, new Deserializer()).create();
    @Getter
    ...
    public static ShopTransactionMessageContainer ofLocalizedMessageWithItem(@NotNull LocalizedMessagePair message,
            @Nullable String hoverItem, @Nullable LocalizedMessagePair hoverText)
    {
    ...
    private static class Deserializer implements JsonDeserializer<ShopTransactionMessageContainer> {
        ...
        @Override
        public ShopTransactionMessageContainer deserialize(JsonElement json, Type typeOfT,
            ...
            if (jsonObject.has("shopTransactionMessage")) {
                ...
                if (jsonObject.has("version")) {
                    ...
                    switch (version) {
                        ...
                        case 1:
                            return new ShopTransactionMessageContainer(
                                    context.deserialize(message, ShopTransactionMessage.V1.class));
                        case 2:
                            return new ShopTransactionMessageContainer(
                                    context.deserialize(message, ShopTransactionMessage.V2.class));
                        case 3:
                            return new ShopTransactionMessageContainer(
                                    context.deserialize(message, ShopTransactionMessage.V3.class));
                        default:
    ...
    public @Nullable String getHoverText(@Nullable String locale) {
        ...
        switch (shopTransactionMessage.getVersion()) {
            ...
            case 3:
                LocalizedMessagePair localizedMessagePair = ((ShopTransactionMessage.V3) shopTransactionMessage)
                        .getHoverText();
